...
const NonConsensusPage = () => {
    ...
    return (
        <div
            onClick={handleOnTapContinue} 
            className='flex flex-col min-h-screen bg-lmk-primary'
        >
            <div className='flex items-center justify-center flex-1'>
                <div className="px-6 mb-6 w-full max-w-[600px] mx-auto flex flex-col justify-center items-center">
                    <TypographyP className='!mt-0 opacity-[0.70] text-[22px] text-white'>except for one thing ...</TypographyP>
                    <TypographyH1 className='text-[96px] lg:text-[96px] leading-none my-2 text-white'>5 vs 1</TypographyH1>
                    <TypographyP className='!mt-0 text-bold text-[16px] text-white'>5 of you want indoor. 1 lone wolf wants outdoor.</TypographyP>
